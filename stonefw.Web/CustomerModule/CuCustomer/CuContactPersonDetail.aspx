    ...
    <div class="form">
        <table cellpadding="5">
            <tr>
                <td>姓名：</td>
                <td>
                    <asp:TextBox ID="txtCpName" runat="server" MaxLength="25" class="easyui-textbox" data-options="required:true"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>手机：</td>
                <td>
                    <asp:TextBox ID="txtMobile" runat="server" MaxLength="25" class="easyui-textbox" data-options="required:true"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>电话：</td>
                <td>
                    <asp:TextBox ID="txtPhone" runat="server" MaxLength="25" class="easyui-textbox" data-options="required:true"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>是否默认：</td>
