        ...
        <div class="form">
            <table cellpadding="5">
                <tr>
                    <td>编号：</td>
                    <td>
                        <asp:TextBox ID="txtCuId" runat="server" MaxLength="25" class="easyui-textbox" data-options="required:true"></asp:TextBox></td>
                    <td>地区：</td>
                    <td>
                        <asp:TextBox ID="txtDistrict" runat="server" MaxLength="25" class="easyui-textbox"></asp:TextBox></td>
                    <td>姓名：</td>
                    <td>
                        <asp:TextBox ID="txtCuName" runat="server" MaxLength="25" class="easyui-textbox" data-options="required:true"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>地址：</td>
                    <td colspan="5">
                        <asp:TextBox ID="txtAddress" runat="server" MaxLength="250" Width="100%" class="easyui-textbox"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>备注：</td>
                    <td colspan="5">
                        <asp:TextBox ID="txtRemark" runat="server" Width="100%" TextMode="MultiLine" class="easyui-textbox" data-options="multiline:true" Style="height: 100px"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>状态：</td>
                    <td colspan="5">
