        ...
        <div class="form">
            <table cellpadding="5">
                ...
                <tr>
                    <td>前缀：</td>
                    <td>
                        <asp:TextBox ID="txtPrefix" runat="server" MaxLength="5" class="easyui-textbox" data-options="required:true"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>日期格式：</td>
                    <td>
                        <asp:TextBox ID="txtDateFormat" runat="server" MaxLength="10" class="easyui-textbox" Enabled="False" ReadOnly="True"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>位数：</td>
                    <td>
                        <asp:TextBox ID="txtDigit" runat="server" class="easyui-textbox" Enabled="False" ReadOnly="True"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>效果展示：</td>
                    <td>
                        <asp:TextBox ID="txtResult" runat="server" class="easyui-textbox" Enabled="False" ReadOnly="True"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>是否默认：</td>
                    <td>
