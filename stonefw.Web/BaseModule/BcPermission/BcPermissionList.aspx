...
<form id="form1" runat="server">
    ...
    <script type="text/javascript">
        $('#<%= ddlPermissionType.ClientID %>').combobox({ onChange: function() { $('#<%= form1.ClientID %>').submit(); } });
        $('#<%= ddlRole.ClientID %>').combobox({ onChange: function() { $('#<%= form1.ClientID %>').submit(); } });
        $('#<%= ddlUser.ClientID %>').combobox({ onChange: function() { $('#<%= form1.ClientID %>').submit(); } });
    </script>
</form>
</body>
</html>