        ...
        <div class="query">
            <table>
                <tr>
                    <td>用户列表：</td>
                    <td>
                        <asp:DropDownList runat="server" ID="ddlUser" class="easyui-combobox" data-options="required:true,panelHeight:'auto',editable:false" /></td>
                    <td>角色列表：</td>
                    <td>
                        <asp:DropDownList runat="server" ID="ddlRole" class="easyui-combobox" data-options="required:true,panelHeight:'auto',editable:false" /></td>
                    <td>
