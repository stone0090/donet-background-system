    ...
    <div class="form">
        <table cellpadding="5">
            <tr>
                <td>用户：</td>
                <td>
                    <asp:DropDownList ID="ddlUser" runat="server" class="easyui-combobox" data-options="required:true,panelHeight:'auto',editable:false"></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td>角色：</td>
                <td>
                    <asp:DropDownList ID="ddlRole" runat="server" class="easyui-combobox" data-options="required:true,panelHeight:'auto',editable:false"></asp:DropDownList>
                </td>
            </tr>
        </table>
        <div class="error">
