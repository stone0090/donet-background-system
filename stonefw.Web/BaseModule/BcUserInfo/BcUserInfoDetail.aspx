    ...
    <div class="form">
        <table cellpadding="5">
            ...
            <tr>
                <td>姓名：</td>
                <td>
                    <asp:TextBox ID="txtUserName" runat="server" MaxLength="25" class="easyui-textbox" data-options="required:true"></asp:TextBox>
                </td>
                <td></td>
                <td>组别：</td>
                <td>
            ...
            <tr>
                <td>手机：</td>
                <td>
                    <asp:TextBox ID="txtMobilePhone" runat="server" MaxLength="25" class="easyui-textbox"></asp:TextBox>
                </td>
                <td></td>
                <td>座机：</td>
                <td>
                    <asp:TextBox ID="txtOfficePhone" runat="server" MaxLength="25" class="easyui-textbox"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>邮件：</td>
                <td colspan="4">
                    <asp:TextBox ID="txtEmail" runat="server" MaxLength="50" Width="100%" class="easyui-textbox"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>角色：</td>
                <td colspan="4">
                    <asp:DropDownList ID="ddlRole" runat="server" Width="100%" class="easyui-combobox" data-options="panelHeight:'auto',multiple:true,editable:false"/>
                </td>
            </tr>
            <tr>
                <td>性别：</td>
