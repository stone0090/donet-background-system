...
namespace stonefw.Utility.EntityExpression.Data
{
    ...
    public static class EntityInstanceTool
    {
        ...
        /// <returns></returns>
        public static D FillOneEntity<D>(IDataReader reader, List<PropertyInfo> entityPropertyInfos) where D : class,new()
        {
            D entity = new D();
        ...
        public static List<string> GetNotNullEntityMembers<E>(E entity, List<string> effectiveEntityMemberNames, List<PropertyInfo> entityPropertyInfos)
        {
        ...
        public static List<PropertyInfo> GetNotNullEntityPropertyInfos<E>(E entity, List<PropertyInfo> entityPropertyInfos)
        {
