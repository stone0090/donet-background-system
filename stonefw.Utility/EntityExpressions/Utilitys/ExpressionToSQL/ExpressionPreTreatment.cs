...
namespace stonefw.Utility.EntityExpressions.Utilitys.ExpressionToSQL
{
    /// <summary>
    /// 预处理，执行部分求值
    /// </summary>
    internal class ExpressionPreTreatment : BaseVisitor
    {
        /// <summary>
        /// 用于判断是否需要求值的委托
        /// </summary>
        ...
        public ExpressionPreTreatment(Func<Expression, bool> fnCanBeEvaluated)
        {
        ...
        /// <returns></returns>
        public Expression DoPreTreatment(Expression exp)
        {
            //调用分析器获取需要进行求值的节点
        ...
        #region 分析器：评估有那些节点需要执行求值操作

        /// <summary>
        /// 分析器：评估有那些节点需要执行求值操作
        /// </summary>
        private class Nominator : BaseVisitor
        {
            /// <summary>
            /// 评估器的委托
            /// </summary>
