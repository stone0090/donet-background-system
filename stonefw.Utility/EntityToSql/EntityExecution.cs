...
using static stonefw.Utility.EntityToSql.Data.EntityOperation;

namespace stonefw.Utility.EntityToSql
{
    /// <summary>
    /// 实体执行方法
    /// </summary>
    public class EntityExecution
    {
        ...
        /// 数据库表、字段的属性缓存
        /// </summary>
        public static Dictionary<string, Dictionary<string, Field>> DatabaseMapping = new Dictionary<string, Dictionary<string, Field>>();
        ...
        {
            EntityOperation.InsertEntity(entity, DB);
        }
        ...
        {
            return EntityOperation.InsertEntityWithIdentity(entity, DB);
        }
        ...
        {
            return EntityOperation.SelectSingleMember(conditionExpression, keySelector, DB);
        }
        ...
        {
            return EntityOperation.SelectSingleMember(whereEntity, keySelector, DB);
        }
        ...
        {
            return EntityOperation.SelectSingleMemberList(conditionExpression, keySelector, DB);
        }
        ...
        {
            return EntityOperation.SelectSingleMemberList(whereEntity, keySelector, DB);
        }
        ...
        {
            return EntityOperation.SelectMembers(conditionExpression, memberExpression, DB, maxRowCounts);
        }
        ...
        {
            return EntityOperation.SelectMembers(whereEntity, memberExpression, DB, maxRowCounts);
        }
        ...
        {
            return EntityOperation.DeleteEntity(conditionExpression, DB);
        }
        ...
        {
            return EntityOperation.DeleteEntity(whereEntity, DB);
        }
        ...
        {
            return EntityOperation.DeleteEntity(theEntity, DB);
        }
        ...
        {
            EntityOperation.UpdateEntity(theEntity, DB);
        }
        ...
        {
            EntityOperation.UpdateEntity(whereEntity, theEntity, DB);
        }
        ...
        {
            EntityOperation.UpdateEntity(conditionExpression, theEntity, DB);
        }
        ...
        {
            EntityOperation.SetMemberNull(whereEntity, keySelector, DB);
        }
        ...
        {
            EntityOperation.SetMemberNull(conditionExpression, keySelector, DB);
        }
        ...
        {
            EntityOperation.SetMembersNull(whereEntity, DB, keySelectors);
        }
        ...
        {
            EntityOperation.SetMembersNull(conditionExpression, DB, keySelectors);
        }
        ...
        {
            return EntityOperation.ReadEntity(conditionExpression, DB);
        }
        ...
        {
            return EntityOperation.ReadEntity(whereEntity, DB);
        }
        ...
        {
            return EntityOperation.ReadEntityList(conditionExpression, DB, maxRowCounts);
        }
        ...
        {
            return EntityOperation.ReadEntityList(whereEntity, DB, maxRowCounts);
        }
        ...
        {
            return EntityOperation.GetEntityCount(conditionExpression);
        }
        ...
        //{
        //    return EntityOperation.ExistsRecord2(conditionExpression);
        //}
        ...
        //{
        //    return EntityOperation.ReadMainEntity2(mainConditionExpression, subConditionExpression, joinConditionExpression, DB);
        //}
        ...
        //{
        //    return EntityOperation.ReadMainEntity(joinEntity, DB);
        //}
        ...
        //{
        //    return EntityOperation.ReadSubEntity2(mainConditionExpression, subConditionExpression, joinConditionExpression, DB);
        //}
        ...
        //{
        //    return EntityOperation.ReadSubEntity(joinEntity, DB);
        //}
        ...
        //{
        //    return EntityOperation.ReadDetailsEntityList2(mainConditionExpression, detailsConditionExpression, joinConditionExpression, DB, maxRowCounts);
        //}
        ...
        //    params int[] maxRowCounts) where DetailsTable : class, new()
        //{
        //    return EntityOperation.ReadDetailsEntityList(joinEntity, DB);
        //}
        ...
        //    params int[] maxRowCounts) where DetailsTable : class, new()
        //{
        //    return EntityOperation.ReadDetailsEntityList2(mainConditionExpression, subConditionExpression, detailsConditionExpression, joinConditionExpression0, joinConditionExpression1, DB, maxRowCounts);
        //}
        ...
        //    params int[] maxRowCounts) where DetailsTable : class, new()
        //{
        //    return EntityOperation.ReadDetailsEntityList(joinEntity0, joinEntity1, DB, maxRowCounts);
        //}
